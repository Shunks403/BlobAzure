...
internal class BlobService
{
    ...
    //дз
    public async Task UploadObjectAsync<T>(BlobContainerClient container, string blobName, T obj)
    {
    ...
    public async Task<T> DownloadObjectAsync<T>(BlobContainerClient container, string blobName)
    {
        var blobClient = container.GetBlobClient(blobName);
    ...
    public async Task<string> GetBlobObjectTypeAsync(BlobContainerClient container, string blobName)
    {
        var blobClient = container.GetBlobClient(blobName);
        var properties = await blobClient.GetPropertiesAsync();

       
        if (properties.Value.Metadata.TryGetValue("ObjectType", out string objectType))
        {
            return objectType;
        }
        return null;
